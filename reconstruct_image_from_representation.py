...
def reconstruct_image_from_representation(config):
    ...
    if should_reconstruct_content:
        ...
        if should_visualize_representation:
            ...
            print("Number of feature maps: ",num_of_feature_maps)
...
if __name__ == "__main__":
    ...
    #I chose jpg cuz it saves a lot of bandwidth and provides high resolution
    ...
    #1 means saving all intermediate images
    parser.add_argument("--model", type=str, choices=['vgg16', 'vgg19'], default='vgg19')
    #why VGG instead of CNN? 
    # the feature maps do not work give as optimal results as well as those of VGG16 or VGG19 
    parser.add_argument("--optimizer", type=str, choices=['lbfgs', 'adam'], default='adam')
    #lbfgs shows higher performance, but takes too much GPU. 
    #I can either try to configure lbfgs, use vgg16(smaller and shallower model than vgg19)
    ...
    #uncomment above function to have a video that shows how it changes 
